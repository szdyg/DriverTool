...
{
    CDialogEx::DoDataExchange(pDX);
    DDX_Control(pDX, IDC_EDIT_COM_ERROR, _ComError);
    DDX_Text(pDX, IDC_EDIT_LOG, _Driverlog);
    DDX_Text(pDX, IDC_EDIT_PATH, _DriverPath);
    DDX_Control(pDX, IDC_EDIT_WIN32_ERROR, _Win32Error);
